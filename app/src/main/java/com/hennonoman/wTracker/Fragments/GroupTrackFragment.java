 ...
 */
public class GroupTrackFragment extends Fragment implements OnMapReadyCallback ,Runnable {
    ...
    public static GroupTrackFragment newInstance(String param1, String param2) {
        GroupTrackFragment fragment = new GroupTrackFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_group_track,container,false);
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference().child("groups").child(GroupActivity.group_id);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mapFragment = (SupportMapFragment) getChildFragmentManager()
                .findFragmentById(R.id.map_view_track);
