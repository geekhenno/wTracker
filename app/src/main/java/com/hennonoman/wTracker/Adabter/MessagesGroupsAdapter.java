...
public class MessagesGroupsAdapter extends FirebaseRecyclerAdapter<Message, MessagesGroupsAdapter.MessageViewHolder> {
    ...
    public MessagesGroupsAdapter(Context context, String ownerUid, Query ref) {
        super(Message.class, R.layout.item_message_group_sent, MessageViewHolder.class, ref);
    ...
    public int getItemViewType(int position) {
        ...
        if (message.getFrom().equals(mUser.getUid())) {
        ...
        switch (viewType) {
            case VIEW_TYPE_SENT:
                itemView = LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.item_message_group_sent, parent, false);
                break;
    ...
    class MessageViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
        ...
        @BindView(R.id.item_message_user_text_view)
        TextView itemUserBodyTextView;
        ...
        MessageViewHolder(View itemView) {
            ...
            itemUserBodyTextView.setOnClickListener(this);
        }
        ...
        void setMessage(Message message) {
            ...
            int viewType = MessagesGroupsAdapter.this.getItemViewType(getLayoutPosition());
            itemMessageBodyTextView.setText(message.getBody());
            itemUserBodyTextView.setText(message.getName());
